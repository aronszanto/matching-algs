...
4 3 [3, 1, 2, 4, 0]
\end{verbatim}
Here, preferences are generated via the double-normal distribution.\\\\The testing for YRM is similar, except the number of houses assigned is less than the total number of agents.
